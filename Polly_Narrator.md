...
My second project has been completed. I ran into trouble as the guide recommended to change the Lambda function's index.mjs to index.js. After seeing the error flag it looked like all I needed to do was revert it back and it worked afterward and I removed that step from my notes here.  
